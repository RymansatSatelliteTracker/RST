...
export default class I18nMsgs {
  ...
  public static readonly CHK_ERR_GET_TLE: I18nMsgItem = {
    en: "Cannot retrieve orbital data from the specified URL ({0})",
    ja: "指定のURLから軌道要素データを取得できません ({0})",
  };
  ...
  public static readonly G32_TLE_LOAD: I18nMsgItem = { en: "Orbital Data Load", ja: "軌道要素読み込み" };
